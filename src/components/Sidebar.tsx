...
export const Sidebar: React.FC<SidebarProps> = ({ activeTab, setActiveTab, unpostedOcrCount = 0, unreconciledBankCount = 0, lowStockCount = 0 }) => {
  const menuItems = [
  ...
  return <>
    ...
    <nav className="lg:hidden fixed bottom-0 inset-x-0 z-40 bg-white/95 backdrop-blur-lg border-t border-slate-200 shadow-[0_-4px_16px_rgba(15,23,42,0.08)] px-1 pb-[env(safe-area-inset-bottom)]">
