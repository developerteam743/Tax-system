  ...
  <header className="sticky top-0 z-30 bg-white/95 backdrop-blur-md border-b border-slate-200 text-slate-800 px-3 sm:px-4 py-2.5 shadow-sm">
    <div className="max-w-7xl mx-auto flex flex-wrap items-center justify-between gap-2 sm:gap-4">
      ...
      <div className="flex items-center justify-end gap-1.5 sm:gap-2 flex-wrap shrink-0">
        ...
        <button onClick={() => setIsMobileSimulator(!isMobileSimulator)} className={`flex items-center gap-1.5 text-xs px-2 py-1.5 rounded-xl border min-h-9 ${isMobileSimulator ? 'bg-purple-600 text-white border-purple-500 shadow-md' : 'bg-slate-100 text-slate-700 border-slate-200'}`} title="Toggle mobile simulator"><Smartphone className="w-3.5 h-3.5" /><span className="hidden sm:inline">Partner Mobile</span></button>
